...
class Predict:
    def __init__(self, db_depth_path: pathlib.Path, descriptors):
        self.depth_path: pathlib.Path = db_depth_path
        self.descriptors = descriptors

    def eval(self, eval_value: Union[np.ndarray, pathlib.Path]) -> np.ndarray:
        pass
